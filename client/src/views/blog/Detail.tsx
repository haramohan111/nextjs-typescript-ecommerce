        ...
        <div className="row">
          <div className="col-md-8">
            ...
            <div className="mb-3">
              ...
              <Link href="/" className="badge text-decoration-none bg-dark me-2">
                #html5
              </Link>
            </div>
            <p>
            ...
            <div className="border-top border-bottom py-3 mb-3">
              ...
              <div className="float-end">
                <Link href="/" className="btn btn-sm bg-twitter me-2 p-0">
                  <i className="bi bi-twitter-x text-white mx-1"></i>
                </Link>
                <Link href="/" className="btn btn-sm bg-facebook me-2 p-0">
                  <i className="bi bi-facebook text-white mx-1"></i>
                </Link>
                <Link href="/" className="btn btn-sm bg-instagram me-2 p-0">
                  <i className="bi bi-instagram text-white mx-1"></i>
                </Link>
                <Link href="/" className="btn btn-sm bg-google p-0">
