...
// Combined props type
type CombinedProps = InjectedFormProps<ProfileFormValues, ProfileFormProps> & ProfileFormProps;

const ProfileForm: React.FC<CombinedProps> = ({
  handleSubmit,
  submitting,
  onSubmit,
  submitFailed,
...
export default compose(
  reduxForm<ProfileFormValues, ProfileFormProps>({
    form: "profile",
  })
)(ProfileForm);
